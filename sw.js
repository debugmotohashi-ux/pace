const CACHE='pace-nexus-20260728-1';
const ASSETS=['./','./index.html','./pace-data-v12.js','./nexus-cloud.js','./manifest.webmanifest','./icon-192.png','./icon-512.png','./icon-180.png','./icon-maskable-512.png'];
